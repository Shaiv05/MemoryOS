...
RAG_FINAL_CONTEXT_CHUNKS = int(os.getenv("RAG_FINAL_CONTEXT_CHUNKS", "3"))
RAG_MIN_RETRIEVAL_SCORE = float(os.getenv("RAG_MIN_RETRIEVAL_SCORE", "0.30"))
RAG_MAX_CONTEXT_TOKENS = int(os.getenv("RAG_MAX_CONTEXT_TOKENS", "1500"))
RAG_SCORE_DROP_CUTOFF = float(os.getenv("RAG_SCORE_DROP_CUTOFF", "0.40"))
